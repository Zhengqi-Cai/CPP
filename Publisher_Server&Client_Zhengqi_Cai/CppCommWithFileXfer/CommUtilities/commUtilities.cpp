...
std::string commUtilities::ToDecAddressString(size_t address)
{
...
std::string commUtilities::ToHexAddressString(size_t address)
{
  std::ostringstream oss;
