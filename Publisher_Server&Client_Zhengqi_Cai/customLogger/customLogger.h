...
* --------------------
* ver 1.3 : Apr 15 2019
* - add logOpen for write and title
* ver 1.2 : 27 Aug 2016
...
namespace customLogging
{
  ...
  public:
	...
	bool isAttached() { return streams_.size(); }
    void start();
    bool running();
    ...
    void wait();
    void write(bool logOpen, const std::string& msg);
    void title(bool logOpen, const std::string& msg, char underline = '-');
    ~Logger();
  ...
  public:
	...
	static bool isAttached() { return _logger.isAttached(); }
    ...
    static void write(bool logOpen, const std::string& msg) { _logger.write(logOpen, msg); }
    static void title(bool logOpen, const std::string& msg, char underline = '-') { _logger.title(logOpen, msg, underline); }
