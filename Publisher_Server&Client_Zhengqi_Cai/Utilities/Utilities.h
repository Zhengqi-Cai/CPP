...
namespace oldUtilities
{
  ...
  public:
    ...
    static void Title(bool logOpen, std::string src);
    static void title(bool logOpen, std::string src);
    static void sTitle(
		bool logOpen, std::string src, size_t offset, size_t width, char underline = '-'
    );
  };

  void putline(bool logOpen);
